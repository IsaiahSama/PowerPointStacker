...
class PresentationManager {
    ...
    async navigate(direction) {
        ...
        switch (direction) {
            case types_1.NavigationDirection.NEXT:
                ...
                break;
            case types_1.NavigationDirection.PREVIOUS:
                ...
                break;
            case types_1.NavigationDirection.NEXT_PRESENTATION:
                if (currentIndex < this.queue.order.length - 1) {
                    this.queue.currentPresentationId = this.queue.order[currentIndex + 1];
                    this.queue.currentSlideNumber = 1;
                }
                break;
            case types_1.NavigationDirection.PREVIOUS_PRESENTATION:
                if (currentIndex > 0) {
                    this.queue.currentPresentationId = this.queue.order[currentIndex - 1];
                    this.queue.currentSlideNumber = 1;
                }
                break;
            case types_1.NavigationDirection.FIRST_SLIDE:
                this.queue.currentSlideNumber = 1;
                break;
            case types_1.NavigationDirection.LAST_SLIDE:
